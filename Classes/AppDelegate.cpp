...
void AppDelegate::preLoadSource(){
	CsvUtil::getInstance()->addFileData(CSVFILE_ROLE);
	CsvUtil::getInstance()->addFileData(CSVFILE_MONSTER);
	CsvUtil::getInstance()->addFileData(CSVFILE_ROLE_TEXTURE_POS);
	CsvUtil::getInstance()->addFileData(CSVFILE_WEAPON_TEXTURE_POS);

	SaveSystem::getInstance();
}

void AppDelegate::unLoadSource(){
	CsvUtil::getInstance()->releaseFile(CSVFILE_ROLE);
	CsvUtil::getInstance()->releaseFile(CSVFILE_MONSTER);
	CsvUtil::getInstance()->releaseFile(CSVFILE_ROLE_TEXTURE_POS);
	CsvUtil::getInstance()->releaseFile(CSVFILE_WEAPON_TEXTURE_POS);
}