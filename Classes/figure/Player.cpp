...
void Player::initWithPlayer()
{
	...
	this->setNickName(_playerController->getPlayerName());
    this->setTray();

	int index = CsvUtil::getInstance()->findValueInWithLine(StringUtils::format("%d", _playerController->getPlayerNumber()), en_role_id, CSVFILE_ROLE);

    this->setBlood(CsvUtil::getInstance()->getInt(index, en_role_hp, CSVFILE_ROLE));
    this->setBloodCap(getBlood());
	this->setMagic(CsvUtil::getInstance()->getInt(index, en_role_mp, CSVFILE_ROLE));
	this->setMagicCap(getMagic());
    this->setTheAttack(CsvUtil::getInstance()->getInt(index, en_role_attack, CSVFILE_ROLE));
    this->setVisualRange(CsvUtil::getInstance()->getInt(index, en_role_visual_range, CSVFILE_ROLE));
